...
<!-- 
python ddpo.py   --num_epochs=1 --train_gradient_accumulation_steps=1 --sample_num_steps=50    --sample_batch_size=2 --train_batch_size=1 --sample_num_batches_per_epoch=1 --per_prompt_stat_tracking=True    --per_prompt_stat_tracking_buffer_size=32 --tracker_project_name="stable_diffusion_training" --logdir="ll_command"     --save_freq=200  --log_with="wandb" --train_num_inner_epochs=1 --pretrained_model="stabilityai/stable-diffusion-2-1" --offline_data_folder="./inputs/data_offline/"  --save_folder="./outputs/lora_weights/test" --load_folder="./outputs/lora_weights/test_100e"     --resume_from = "./outputs/save/checkpoints/checkpoint_0"
...
d:; cd 'd:\THESIS\Thesis_UIT\trl0';  & 'c:\Users\Administrator\.conda\envs\ddpo_gpu\python.exe' 'c:\Users\Administrator\.vscode\extensions\ms-python.debugpy-2024.10.0-win32-x64\bundled\libs\debugpy\adapter/../..\debugpy\launcher' '52939' '--' 'd:\THESIS\Thesis_UIT\trl0\

python examples\scripts\ddpo.py   
--num_epochs=1 --train_gradient_accumulation_steps=1 --sample_num_steps=50    --sample_batch_size=2 --train_batch_size=1 --sample_num_batches_per_epoch=1 --per_prompt_stat_tracking=True    --per_prompt_stat_tracking_buffer_size=32 --tracker_project_name="stable_diffusion_training" --logdir="ll"     --save_freq=200  --log_with="wandb" --train_num_inner_epochs=1 --pretrained_model="stabilityai/stable-diffusion-2-1" --offline_data_folder="../data_offline/"  --save_folder="../100e_beau_withScore" --load_folder="../test_100e" 



!python examples/scripts/ddpo.py 
    --num_epochs=1 --train_gradient_accumulation_steps=1 --sample_num_steps=50 
    --sample_batch_size=2 --train_batch_size=2 --sample_num_batches_per_epoch=2 --per_prompt_stat_tracking=True 
    --per_prompt_stat_tracking_buffer_size=32 --tracker_project_name="stable_diffusion_training" --logdir="ll" 
    --save_freq=200  --log_with="wandb" --train_num_inner_epochs=1 --pretrained_model="stabilityai/stable-diffusion-2-1" --offline_data_folder='../data_offline/' --save_folder="../test"  
 -->
